				...
				<div class="fh5co-intro">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-6 col-md-offset-3 text-center fh5co-text">
								<h2 class="to-animate intro-animate-1">Natured is bringing you fresh local food.</h2>
								...
								<p class="to-animate intro-animate-3">
                                             ...
                                             <a href="#" class="btn btn-primary btn-md"><i class="icon-apple"></i> Add me to the waitlist</a>
				...
				<div id="fh5co-clients">
					<div class="container">
						<div class="row text-center">
							...
							<div class="col-md-4 col-md-offset-4 col-sm-6 col-xs-6 col-sm-offset-3 col-xs-offset-3 to-animate">
								<figure class="fh5co-client"><img width="250px" src="images/natured_logo.png" alt="Natured Logo"></figure>
							</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 fh5co-section-heading text-center">
								<h2 class="fh5co-lead to-animate">Explore amazing local food</h2>
							...
							<div class="col-md-4 col-sm-4 col-xs-12 col-xxs-12">
								<a href="#" class="fh5co-feature to-animate">
									...
									<h3 class="fh5co-feature-lead">Produce</h3>
							...
							<div class="col-md-4 col-sm-4 col-xs-12 col-xxs-12">
								<a href="#" class="fh5co-feature to-animate">
									...
									<h3 class="fh5co-feature-lead">Honey</h3>
									<p class="fh5co-feature-text">Far far away behind the word mountains</p>
								</a>
							</div>
							...
							<div class="col-md-4 col-sm-4 col-xs-12 col-xxs-12">
								<a href="#" class="fh5co-feature to-animate">
									...
									<h3 class="fh5co-feature-lead">Jerky</h3>
									<p class="fh5co-feature-text">Far far away behind the word mountains</p>
								</a>
							</div>
								...
								<div class="fh5co-hero-wrap">
									<div class="fh5co-hero-intro text-center to-animate counter-animate">
										<div class="col-md-4 text-center">
											...
											<span class="fh5co-counter-label">Farmer</span>
											
										</div>
										<div class="col-md-4 text-center">
											<span class="fh5co-counter js-counter" data-from="0" data-to="1500" data-speed="5000" data-refresh-interval="50"></span>
											<span class="fh5co-counter-label">Jars of honey</span>
										</div>
										<div class="col-md-4 text-center">
											<span class="fh5co-counter js-counter" data-from="0" data-to="87120" data-speed="5000" data-refresh-interval="50"></span>
											<span class="fh5co-counter-label">Square feet of farm land</span>
										</div>
									</div>
								</div>
							</div>
